const phones =[
    {name: 'samsang', camara: 12, storage: '32gb', price: 3600, color: 'silver'},
    ...
    {name: 'HTC', camara: 12, storage: '32gb', price: 44000, color: 'silver'},
];
...
const mySelictionPhone = cheapestPricePhone(phones)
console.log(mySelictionPhone);